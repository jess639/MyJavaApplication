...
//  int BB=980,CC=540;//16度
  ...
  g.drawString("冷藏室背面剩余 ", a3-780+820,b3-510+640-h);
  g.drawString("A=", a3-780+800-15,b3-510+840-h);
  g.drawString(di.format(vip.A2bbig)+"mm", a3-780+815-15,b3-510+840-h);
  g.drawString("w=", a3-780+800-15,b3-510+860-h);
  g.drawString(di.format(vip.w2bbig)+"mm", a3-780+815-15,b3-510+860-h);
  g.drawString("h=", a3-780+880-15,b3-510+860-h);
  g.drawString(di.format(vip.h2bbig)+"mm", a3-780+895-15,b3-510+860-h);
  g.drawString("B=", a3-780+880-15,b3-510+840-h);
  g.drawString(di.format(vip.B2bbig)+"mm", a3-780+895-15,b3-510+840-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", a3-780+800-15,b3-510+880-h);
  if(vip.a2bbig>0){g.drawString(di.format(vip.a2bbig+vip.supply)+"mm", a3-780+815-15,b3-510+880-h);}else if(vip.a2bbig==0){g.drawString(di.format(vip.a2bbig)+"mm", a3-780+815-15,b3-510+880-h);}

  g.drawString("b=", a3-780+880-15,b3-510+880-h);
  g.drawString(di.format(vip.b2bbig)+"mm", a3-780+895-15,b3-510+880-h);
  g.setColor(Color.blue);  //设置画笔颜色 
  ...
  g.drawString(di.format(vip.A2bsmall)+"mm", a6-780+815-15,b6-510+840-h);
  g.drawString("w=", a6-780+800-15,b6-510+860-h);
  g.drawString(di.format(vip.w2bsmall)+"mm", a6-780+815-15,b6-510+860-h);
  g.drawString("h=", a6-780+880-15,b6-510+860-h);
  g.drawString(di.format(vip.h2bsmall)+"mm", a6-780+895-15,b6-510+860-h);
  g.drawString("B=", a6-780+880-15,b6-510+840-h);
  g.drawString(di.format(vip.B2bsmall)+"mm", a6-780+895-15,b6-510+840-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", a6-780+800-15,b6-510+880-h);
  g.drawString(di.format(vip.a2bsmall)+"mm", a6-780+815-15,b6-510+880-h);
  g.drawString("b=", a6-780+880-15,b6-510+880-h);
  g.drawString(di.format(vip.b2bsmall)+"mm", a6-780+895-15,b6-510+880-h);
  g.setColor(Color.blue);  //设置画笔颜色 
  ...
  g.drawString(di.format(vip.A2l)+"mm", a1-120+172-30,b1-510+840-h);
  g.drawString("B=", a1-120+230-30,b1-510+840-h);
  g.drawString(di.format(vip.B2l)+"mm", a1-120+245-30,b1-510+840-h);
  g.drawString("w=", a1-120+155-30,b1-510+860-h);
  g.drawString(di.format(vip.w2l)+"mm", a1-120+170-30,b1-510+860-h);
  g.drawString("h=", a1-120+230-30,b1-510+860-h);
  g.drawString(di.format(vip.h2l)+"mm", a1-120+245-30,b1-510+860-h);
  ...
  g.drawString("B", a1+80,b1-510+520);
  g.drawString("b", a1+110,b1-510+650-h);
  g.drawString("h", a1+155,b1-510+650-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", a1-120+155-30,b1-510+880-h);
  g.drawString(di.format(vip.a2l)+"mm", a1-120+170-30,b1-510+880-h);
  g.drawString("b=", a1-120+230-30,b1-510+880-h);
  g.drawString(di.format(vip.b2l)+"mm", a1-120+245-30,b1-510+880-h);
...
//  g.drawString("冷藏室右侧面  （尺寸同左侧面）", 560,840);
  ...
  g.drawString(di.format(vip.A2r)+"mm", a2-560+622-30-15,b2-510+840-h);
  g.drawString("B=", a2-560+680-30-15,b2-510+840-h);
  g.drawString(di.format(vip.B2r)+"mm", a2-560+695-30-15,b2-510+840-h);
  g.drawString("w=", a2-560+605-30-15,b2-510+860-h);
  g.drawString(di.format(vip.w2r)+"mm", a2-560+620-30-15,b2-510+860-h);
  g.drawString("h=", a2-560+680-30-15,b2-510+860-h);
  g.drawString(di.format(vip.h2r)+"mm", a2-560+695-30-15,b2-510+860-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", a2-560+605-30-15,b2-510+880-h);
  g.drawString(di.format(vip.a2r)+"mm", a2-560+620-30-15,b2-510+880-h);
  g.drawString("b=", a2-560+680-30-15,b2-510+880-h);
  g.drawString(di.format(vip.b2r)+"mm", a2-560+695-30-15,b2-510+880-h);
  g.setColor(Color.blue);  //设置画笔颜色 
...
//  g.drawString(dg.format(vip.A2ld)+"mm", a4-780+815-15,b4-110+440-h); 
//  g.drawString("w=", a4-780+800-15,b4-110+460-h);
//  g.drawString(vip.w2ld+"mm", a4-780+815-15,b4-110+460-h);
//  g.drawString("h=", a4-780+880-15,b4-110+460-h);
//  g.drawString(vip.h2ld+"mm", a4-780+895-15,b4-110+460-h);
//  g.drawString("B=", a4-780+880-15,b4-110+440-h);
//  g.drawString(vip.B2ld+"mm", a4-780+895-15,b4-110+440-h);
//  g.setColor(Color.red);  //设置画笔颜色 
//  g.drawString("a=", a4-780+800-15,b4-110+480-h);
//  g.drawString(vip.a2ld+"mm", a4-780+815-15,b4-110+480-h);
//  g.drawString("b=", a4-780+880-15,b4-110+480-h);
//  g.drawString(vip.b2ld+"mm", a4-780+895-15,b4-110+480-h);
//  g.setColor(Color.blue);  //设置画笔颜色 
...
//  g.drawString("A", a4-780+790,b4-110+380-h);
  ...
  g.drawString("冷藏室右门 ", a5-780+830,b5-110+240-h);
  g.drawString("A=", a5-780+800-15,b5-110+440-h);
  g.drawString(di.format(vip.A2rd)+"mm", a5-780+815-15,b5-110+440-h);
  g.drawString("w=", a5-780+800-15,b5-110+460-h);
  g.drawString(di.format(vip.w2rd)+"mm", a5-780+815-15,b5-110+460-h);
  g.drawString("h=", a5-780+880-15,b5-110+460-h);
  g.drawString(di.format(vip.h2rd)+"mm", a5-780+895-15,b5-110+460-h);
  g.drawString("B=", a5-780+880-15,b5-110+440-h);
  g.drawString(di.format(vip.B2rd)+"mm", a5-780+895-15,b5-110+440-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", a5-780+800-15,b5-110+480-h);
  g.drawString(di.format(vip.a2rd)+"mm", a5-780+815-15,b5-110+480-h);
  g.drawString("b=", a5-780+880-15,b5-110+480-h);
  g.drawString(di.format(vip.b2rd)+"mm", a5-780+895-15,b5-110+480-h);
  g.setColor(Color.blue);  //设置画笔颜色 
...
//  g.drawLine(850, 780, 850, 810);//D
  ...
  g.drawString(di.format(vip.A1b)+"mm", A3-780+815-15,B3-110+440-h);
  g.drawString("w=", A3-780+800-15,B3-110+460-h);
  g.drawString(di.format(vip.w1b)+"mm", A3-780+815-15,B3-110+460-h);
  g.drawString("h=", A3-780+880-15,B3-110+460-h);
  g.drawString(di.format(vip.h1b)+"mm", A3-780+895-15,B3-110+460-h);
  g.drawString("B=", A3-780+880-15,B3-110+440-h);
  g.drawString(di.format(vip.B1b)+"mm", A3-780+895-15,B3-110+440-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", A3-780+800-15,B3-110+480-h);
  g.drawString(di.format(vip.a1b)+"mm", A3-780+815-15,B3-110+480-h);
  g.drawString("b=", A3-780+880-15,B3-110+480-h);
  g.drawString(di.format(vip.b1b)+"mm", A3-780+895-15,B3-110+480-h);
  g.setColor(Color.blue);  //设置画笔颜色 
  ...
  g.drawString("A=", A5-780+800-15,B5-110+440-h);
  g.drawString(di.format(vip.A1ld)+"mm", A5-780+815-15,B5-110+440-h);
  g.drawString("w=", A5-780+800-15,B5-110+460-h);
  g.drawString(di.format(vip.w1ld)+"mm", A5-780+815-15,B5-110+460-h);
  g.drawString("h=", A5-780+880-15,B5-110+460-h);
  g.drawString(di.format(vip.h1ld)+"mm", A5-780+895-15,B5-110+460-h);
  g.drawString("B=", A5-780+880-15,B5-110+440-h);
  g.drawString(di.format(vip.B1ld)+"mm", A5-780+895-15,B5-110+440-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", A5-780+800-15,B5-110+480-h);
  g.drawString(di.format(vip.a1ld)+"mm", A5-780+815-15,B5-110+480-h);
  g.drawString("b=", A5-780+880-15,B5-110+480-h);
  g.drawString(di.format(vip.b1ld)+"mm", A5-780+895-15,B5-110+480-h);
  g.setColor(Color.blue);  //设置画笔颜色 
  g.drawString("a", A5-780+850,B5-110+375-h);
  g.drawString("b", A5-780+900,B5-110+250);
  g.drawString("h", A5-780+935,B5-110+250);
  ...
  g.drawString(di.format(vip.A1rd)+"mm", A6-780+815-15,B6-110+440-h);
  g.drawString("w=", A6-780+800-15,B6-110+460-h);
  g.drawString(di.format(vip.w1rd)+"mm", A6-780+815-15,B6-110+460-h);
  g.drawString("h=", A6-780+880-15,B6-110+460-h);
  g.drawString(di.format(vip.h1rd)+"mm", A6-780+895-15,B6-110+460-h);
  g.drawString("B=", A6-780+880-15,B6-110+440-h);
  g.drawString(di.format(vip.B1rd)+"mm", A6-780+895-15,B6-110+440-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", A6-780+800-15,B6-110+480-h);
  g.drawString(di.format(vip.a1rd)+"mm", A6-780+815-15,B6-110+480-h);
  g.drawString("b=", A6-780+880-15,B6-110+480-h);
  g.drawString(di.format(vip.b1rd)+"mm", A6-780+895-15,B6-110+480-h);
  g.setColor(Color.blue);  //设置画笔颜色 
  ...
  g.drawString(di.format(vip.A1l)+"mm", A1-120+172-30,B1-110+440-h);
  g.drawString("B=", A1-120+230-30,B1-110+440-h);
  g.drawString(di.format(vip.B1l)+"mm", A1-120+250-30,B1-110+440-h);
  g.drawString("w=", A1-120+155-30,B1-110+460-h);
  g.drawString(di.format(vip.w1l)+"mm", A1-120+170-30,B1-110+460-h);
  g.drawString("h=", A1-120+230-30,B1-110+460-h);
  g.drawString(di.format(vip.h1l+vip.h1ldown)+"mm", A1-120+250-30,B1-110+460-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", A1-120+155-30,B1-110+480-h);
  g.drawString(di.format(vip.a1l)+"mm", A1-120+170-30,B1-110+480-h);
  g.drawString("b=", A1-120+230-30,B1-110+480-h);
  g.drawString(di.format(vip.b1l)+"mm", A1-120+250-30,B1-110+480-h);
  g.drawString("a1=", A1-120+150-30,B1-110+500-h);
  g.drawString(di.format(vip.a1ldown)+"mm", A1-120+170-30,B1-110+500-h);
  g.drawString("b1=", A1-120+230-30,B1-110+500-h);
  g.drawString(di.format(vip.b1ldown)+"mm", A1-120+250-30,B1-110+500-h);
  g.setColor(Color.blue);  //设置画笔颜色 
  g.drawString("a", A1-120+170,B1-110+135);
  ...
  g.drawString("b1", A1+75, B1+265-h);
  g.setColor(Color.red);  //设置画笔颜色 
  ...
  g.drawString(di.format(vip.A1r)+"mm", A2-120+172-30,B2-110+440-h);
  g.drawString("B=", A2-120+230-30,B2-110+440-h);
  g.drawString(di.format(vip.B1r)+"mm", A2-120+250-30,B2-110+440-h);
  g.drawString("w=", A2-120+155-30,B2-110+460-h);
  g.drawString(di.format(vip.w1r)+"mm", A2-120+170-30,B2-110+460-h);
  g.drawString("h=", A2-120+230-30,B2-110+460-h);
  g.drawString(di.format(vip.h1r+vip.h1rdown)+"mm", A2-120+250-30,B2-110+460-h);
  g.setColor(Color.red);  //设置画笔颜色 
  g.drawString("a=", A2-120+155-30,B2-110+480-h);
  g.drawString(di.format(vip.a1r)+"mm", A2-120+170-30,B2-110+480-h);
  g.drawString("b=", A2-120+230-30,B2-110+480-h);
  g.drawString(di.format(vip.b1r)+"mm", A2-120+250-30,B2-110+480-h);
  g.drawString("a2=", A2-120+150-30,B2-110+500-h);
  g.drawString(di.format(vip.a1rdown)+"mm", A2-120+170-30,B2-110+500-h);
  g.drawString("b2=", A2-120+230-30,B2-110+500-h);
  g.drawString(di.format(vip.b1rdown)+"mm", A2-120+250-30,B2-110+500-h);
  g.setColor(Color.blue);  //设置画笔颜色 
  g.drawString("a", A2-120+170,B2-110+135);
  ...
  g.drawString("b2", A2+75, B2+265-h);
  ...
  g.drawLine(A2+95, B2+235-h, A2+105, B2+235-h);//  heng  10 
  g.drawLine(A2+115, B2+235-h, A2+125, B2+235-h);//  heng  10 
  g.setColor(Color.blue);  //设置画笔颜色 

  g.drawString("("+vip.type+")", B+80,C);
